        ...
        const translations = {
            'zh-TW': {
                ...
                budget_title: "預算分析", budget_desc: "預估每人總花費約 $37,800 TWD。請準備足夠日幣現金。",
                ...
                cat_transport: "🚌 交通總計", cat_ticket: "🎟️ 票券/門票 (FunPass)", cat_food: "🍱 餐飲/雜支", cat_total_est: "預估小計",
            ...
            'ja-JP': {
                ...
                budget_title: "予算分析", budget_desc: "一人当たりの総費用は約 37,800 TWD (約 18万円) です。",
                ...
                cat_transport: "🚌 交通費合計", cat_ticket: "🎟️ 入場券/パス", cat_food: "🍱 食費/雑費", cat_total_est: "見積もり小計",
            ...
            'zh-TW': {
                1: {
                    ...
                    events: [
                        ...
                        { time: "18:30", icon: "🍽️", title: "晚餐", desc: "飯店自助餐或附近居酒屋", cost: "¥2000-5000", link: null }
                    ]
                },
                2: {
                    title: "北部包車一日遊 (10H)",
            ...
            'ja-JP': {
                1: {
                    ...
                    events: [
                        ...
                        { time: "18:30", icon: "🍽️", title: "夕食", desc: "ホテルビュッフェまたは近隣居酒屋", cost: "¥2000-5000", link: null }
                    ]
                },
                2: {
        ...
        function initChart() {
            ...
            window.budgetChartInstance = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [9693, 9494, 4030, 1450, 12900], // Replaced dynamically
                        backgroundColor: [
                            '#0ea5e9', // Flight
                            '#6366f1', // Stay
                            '#10b981', // Transport
        ...
        function getChartLabels() {
            // Chart simplified to show Paid vs Unpaid ratio or stick to categories?
            // User request was to split the list. Chart can stay categorical but update data.
            // Let's stick to categories as it's more visual for "what" money is spent on.
            // But we need to sum paid + unpaid per category.
        ...
        function updateChart() {
            if (window.budgetChartInstance) {
                // Recalculate Totals
                // Flights: 4649 + 5044 = 9693
                // Stay: 5207 + 4134 + 153 = 9494
                // Transport: 1790 (Paid) + 840 (Paid) + 500 (OAS) + 900 (Local) = 4030
                // Ticket: 1450 (FunPass) + 210 (Orion) = 1660 (Rounding to 1700 approx based on list? List has FunPass 1450 + Orion 210 = 1660. Let's use 1660)
                // Food: 12900
                
                const data = [9693, 9494, 4030, 1660, 12900];
