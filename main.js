 ...
 const translations = {
    'zh-TW': {
        ...
        itinerary_title: "每日詳細行程", itinerary_desc: "點選上方的日期標籤即可切換查看當日的時間軸。",
        
        map_title: "行程地圖", map_desc: "所有景點與路線皆已整合在 Google My Maps 中。", open_map_btn: "在 Google Maps App 開啟",

        budget_title: "預算分析", budget_desc: "預估每人總花費約 $33,000 ~ $35,000 TWD。",
        budget_chart_title: "費用分佈比例 (TWD)", budget_note: "* 餐費為概估值，依個人消費而異",
        budget_list_title: "細項估算 (每人)",
        cat_flight: "✈️ 機票", cat_stay: "🏨 住宿 (5晚)", cat_transport: "🚌 交通總計", cat_ticket: "🎟️ 票券/門票", cat_food: "🍱 餐飲預估", cat_total: "總計預估",
        cash_tip_title: "💡 建議攜帶日幣", cash_tip_desc: "部分老店、計程車僅收現金。建議準備 $8,000~$10,000 TWD 等值日幣。",
        ...
        // Chart Labels
        chart_flight: "機票", chart_stay: "住宿", chart_transport: "交通", chart_ticket: "票券", chart_food: "餐飲"
    },
    'ja-JP': {
        nav_title: "沖縄 2026",
        ...
        budget_title: "予算分析", budget_desc: "一人当たりの総費用は約 33,000 ~ 35,000 TWD (約 16~17万円) です。",
        budget_chart_title: "費用内訳 (TWD)", budget_note: "* 食費は個人の消費により異なります",
        budget_list_title: "詳細見積もり (一人当たり)",
        cat_flight: "✈️ 航空券", cat_stay: "🏨 宿泊 (5泊)", cat_transport: "🚌 交通費合計", cat_ticket: "🎟️ 入場券/パス", cat_food: "🍱 食費(概算)", cat_total: "合計予想",
        cash_tip_title: "💡 現金の準備", cash_tip_desc: "一部の老舗やタクシーは現金のみです。日本円をご用意ください。",
...
const itineraryData = {
    'zh-TW': {
        1: {
            ...
            date: "03/10 (二)",
            events: [
                { time: "04:30", icon: "🛂", title: "桃園機場報到", desc: "第一航廈 IT230 (06:35起飛)", link: "https://www.tigerairtw.com/zh-tw" },
                { time: "08:55", icon: "🛬", title: "抵達那霸機場", desc: "出關、寄放行李、機場早餐(A&W/豬肉蛋飯糰)", cost: "1,000", link: "https://www.naha-airport.co.jp/zh-hant/" },
                { time: "11:50", icon: "⛩️", title: "波上宮 & 海灘", desc: "參拜、買書包御守、踏浪 (停留 2hr)", cost: "2,000 (含車資)", link: "http://naminouegu.jp/" },
                { time: "14:40", icon: "🚌", title: "搭乘 OAS 接駁巴士", desc: "需預約，前往美麗海紀念公園前站", cost: "2,500", link: "https://www.okinawa-shuttle.co.jp/tc/" },
                { time: "18:00", icon: "🏨", title: "Royal View Check-in", desc: "晚餐於飯店自助餐或附近居酒屋", cost: "3,000", link: "https://royalview-churaumi.com/" }
            ]
        },
        2: {
            title: "北部包車一日遊 (10H)",
            date: "03/11 (三)",
            events: [
                { time: "08:30", icon: "🚙", title: "包車出發", desc: "車內嚴禁飲食，時間控制嚴格", cost: "12,000 (分攤)", link: null },
                { time: "09:15", icon: "🌊", title: "古宇利島", desc: "古宇利大橋、心形岩、蝦蝦飯、しらさ食堂、Shinmei Coffee (停留 3hr)", cost: "3,000", link: "https://kourijima.info/" },
                { time: "13:30", icon: "🐘", title: "萬座毛", desc: "Funpass入場，象鼻岩絕景 (停留 1.5hr)", cost: "0 (Funpass)", link: "https://www.manzamo.jp/" },
                { time: "15:50", icon: "🍺", title: "Orion 啤酒廠", desc: "16:00 場次 (務必準時)，駕駛不可飲酒", cost: "500", link: "https://www.orionbeer.co.jp/brewerytour/" },
                { time: "18:20", icon: "🐟", title: "晚餐：海邦丸本店", desc: "海人料理，可能需排隊", cost: "3,000", link: "https://kaihou-maru.com/" }
            ]
        },
        3: {
            title: "水族館・移動至那霸",
            date: "03/12 (四)",
            events: [
                { time: "09:40", icon: "🐋", title: "美麗海水族館", desc: "黑潮之海、海豚劇場 (停留 5hr)，午餐館內解決", cost: "3,000 (含餐)", link: "https://churaumi.okinawa/tc/" },
                { time: "15:15", icon: "🚌", title: "山原急行巴士", desc: "前往縣廳前站 (County Office Station)", cost: "2,000", link: "https://yanbaru-expressbus.com/" },
                { time: "18:30", icon: "🏨", title: "Hotel Naha City Check-in", desc: "靠近國際通", cost: "0", link: "https://hotel-naha-city.jp/" },
                { time: "19:00", icon: "🥩", title: "晚餐：燒肉王/屋台村", desc: "燒肉王建議提前一個月預約", cost: "4,000", link: "https://www.yakiniku-king.jp/" },
                { time: "21:00", icon: "🍸", title: "續攤：El Lequio", desc: "清吧小酌", cost: "2,000", link: "https://www.instagram.com/el_lequio_official/" }
            ]
        },
        4: {
            title: "美國村悠閒遊",
            date: "03/13 (五)",
            events: [
                { time: "08:00", icon: "🍣", title: "早餐：泊港魚市場", desc: "新鮮生魚片、生蠔", cost: "1,500", link: "http://www.tomariiyumachi.com/" },
                { time: "13:27", icon: "🚌", title: "前往美國村", desc: "搭乘 28 號公車", cost: "800", link: "https://www.okinawa-americanvillage.com/" },
                { time: "14:30", icon: "🍽️", title: "午餐：Calif Kitchen", desc: "海景加州風餐廳", cost: "2,000", link: "https://thecalifkitchen.okinawa/" },
                { time: "16:00", icon: "🎡", title: "美國村散策", desc: "Blue Seal 冰淇淋、日落海灘、北谷公園", cost: "1,000", link: null },
                { time: "18:00", icon: "🌅", title: "Transit Cafe", desc: "欣賞日落", cost: "2,000", link: "https://transitcafe-okinawa.com/" },
                { time: "20:20", icon: "🚕", title: "計程車回那霸", desc: "約 45 分鐘", cost: "5,000 (整車)", link: null }
            ]
        },
        5: {
            title: "南部觀光巴士一日遊",
            date: "03/14 (六)",
            events: [
                { time: "08:45", icon: "🚩", title: "集合：縣廳前", desc: "Blue Seal Palette 久茂地店前，準時出發", cost: "7,500 (團費)", link: null },
                { time: "09:30", icon: "🏯", title: "沖繩世界文化王國", desc: "玉泉洞鐘乳石、毒蛇博物館", cost: "0 (含)", link: "https://www.gyokusendo.co.jp/okinawaworld/" },
                { time: "13:40", icon: "🐠", title: "DMM 水族館 & iias", desc: "影像技術水族館，旁有商場", cost: "2,400", link: "https://kariyushi-aquarium.com/tc/" },
                { time: "16:00", icon: "✈️", title: "瀨長島 Umikaji Terrace", desc: "希臘風建築、看飛機、幸福鬆餅", cost: "1,500", link: "https://www.umikajiterrace.com/" },
                { time: "18:15", icon: "🔥", title: "晚餐：炉ばた焼 泉崎", desc: "體驗爐端燒", cost: "3,500", link: "https://tabelog.com/okinawa/A4701/A470101/47000350/" }
            ]
        },
        6: {
            title: "最後採買 & 回家",
            date: "03/15 (日)",
            events: [
                { time: "08:00", icon: "🍚", title: "早餐：風林火山", desc: "日式定食", cost: "1,200", link: null },
                { time: "10:15", icon: "🛍️", title: "國際通衝刺", desc: "唐吉訶德、牧志市場、伴手禮", cost: "10,000+", link: "https://naha-kokusaidori.okinawa/tw/" },
                { time: "13:30", icon: "🚝", title: "前往那霸機場", desc: "午餐在機場解決 (豬肉飯糰/拉麵)", cost: "1,000", link: "https://www.naha-airport.co.jp/zh-hant/" },
                { time: "16:55", icon: "🛫", title: "回程起飛", desc: "泰亞航空 Flight 231", cost: "0", link: "https://www.airasia.com/zh/tw" },
                { time: "19:00", icon: "🏠", title: "平安抵達", desc: "桃園機場解散", cost: "0", link: null }
            ]
        }
    },
    'ja-JP': {
        1: {
            ...
            date: "03/10 (火)",
            events: [
                { time: "04:30", icon: "🛂", title: "桃園空港チェックイン", desc: "T1 タイガーエア IT230 (06:35発)", link: "https://www.tigerairtw.com/jp" },
                { time: "08:55", icon: "🛬", title: "那覇空港到着", desc: "入国、荷物預け、朝食 (A&W/ポークたまご)", cost: "1,000", link: "https://www.naha-airport.co.jp/" },
                { time: "11:50", icon: "⛩️", title: "波上宮 & ビーチ", desc: "参拝、お守り購入、散策 (2時間)", cost: "2,000 (交通込)", link: "http://naminouegu.jp/" },
                { time: "14:40", icon: "🚌", title: "OASバス乗車", desc: "予約制、海洋博公園前へ移動", cost: "2,500", link: "https://www.okinawa-shuttle.co.jp/" },
                { time: "18:00", icon: "🏨", title: "ロイヤルビュー チェックイン", desc: "夕食はホテルビュッフェまたは近隣居酒屋", cost: "3,000", link: "https://royalview-churaumi.com/" }
            ]
        },
        2: {
            ...
            date: "03/11 (水)",
            events: [
                { time: "08:30", icon: "🚙", title: "出発", desc: "車内飲食厳禁、時間は厳守", cost: "12,000 (割勘)", link: null },
                { time: "09:15", icon: "🌊", title: "古宇利島", desc: "古宇利大橋、ハートロック、ガーリックシュリンプ、しらさ食堂、Shinmei Coffee", cost: "3,000", link: "https://kourijima.info/" },
                { time: "13:30", icon: "🐘", title: "万座毛", desc: "Funpass入場、絶景スポット", cost: "0 (Funpass)", link: "https://www.manzamo.jp/" },
                { time: "15:50", icon: "🍺", title: "オリオンビール工場", desc: "16:00 回 (時間厳守)、運転手禁酒", cost: "500", link: "https://www.orionbeer.co.jp/brewerytour/" },
                { time: "18:20", icon: "🐟", title: "夕食：海邦丸 本店", desc: "海人料理、行列の可能性あり", cost: "3,000", link: "https://kaihou-maru.com/" }
            ]
        },
        3: {
            title: "水族館・那覇へ移動",
            date: "03/12 (木)",
            events: [
                { time: "09:40", icon: "🐋", title: "美ら海水族館", desc: "黒潮の海、イルカショー (5時間滞在)、ランチは館内", cost: "3,000 (食事込)", link: "https://churaumi.okinawa/" },
                { time: "15:15", icon: "🚌", title: "やんばる急行バス", desc: "県庁前駅へ移動", cost: "2,000", link: "https://yanbaru-expressbus.com/" },
                { time: "18:30", icon: "🏨", title: "那覇シティ チェックイン", desc: "国際通り近く", cost: "0", link: "https://hotel-naha-city.jp/" },
                { time: "19:00", icon: "🥩", title: "夕食：焼肉きんぐ/屋台村", desc: "焼肉きんぐは1ヶ月前予約推奨", cost: "4,000", link: "https://www.yakiniku-king.jp/" },
                { time: "21:00", icon: "🍸", title: "二次会：El Lequio", desc: "カクテルバー", cost: "2,000", link: "https://www.instagram.com/el_lequio_official/" }
            ]
        },
        4: {
            title: "アメリカンビレッジ散策",
            date: "03/13 (金)",
            events: [
                { time: "08:00", icon: "🍣", title: "朝食：泊いゆまち", desc: "新鮮な刺身、生牡蠣", cost: "1,500", link: "http://www.tomariiyumachi.com/" },
                { time: "13:27", icon: "🚌", title: "アメリカンビレッジへ", desc: "28番バス乗車", cost: "800", link: "https://www.okinawa-americanvillage.com/" },
                { time: "14:30", icon: "🍽️", title: "昼食：Calif Kitchen", desc: "オーシャンビュー カリフォルニアスタイル", cost: "2,000", link: "https://thecalifkitchen.okinawa/" },
                { time: "16:00", icon: "🎡", title: "ビレッジ散策", desc: "ブルーシールアイス、サンセットビーチ", cost: "1,000", link: null },
                { time: "18:00", icon: "🌅", title: "Transit Cafe", desc: "サンセットディナー", cost: "2,000", link: "https://transitcafe-okinawa.com/" },
                { time: "20:20", icon: "🚕", title: "タクシーで那覇へ", desc: "約45分", cost: "5,000 (1台)", link: null }
            ]
        },
        5: {
            title: "南部バスツアー",
            date: "03/14 (土)",
            events: [
                { time: "08:45", icon: "🚩", title: "集合：県庁前", desc: "パレット久茂地 ブルーシール前", cost: "7,500 (ツアー費)", link: null },
                { time: "09:30", icon: "🏯", title: "おきなわワールド", desc: "玉泉洞、ハブ博物公園", cost: "0 (込)", link: "https://www.gyokusendo.co.jp/okinawaworld/" },
                { time: "13:40", icon: "🐠", title: "DMMかりゆし水族館", desc: "映像技術水族館、隣にショッピングモール", cost: "2,400", link: "https://kariyushi-aquarium.com/" },
                { time: "16:00", icon: "✈️", title: "ウミカジテラス", desc: "瀬長島、飛行機鑑賞、パンケーキ", cost: "1,500", link: "https://www.umikajiterrace.com/" },
                { time: "18:15", icon: "🔥", title: "夕食：炉端焼き 泉崎", desc: "ローカルな炉端焼き体験", cost: "3,500", link: "https://tabelog.com/okinawa/A4701/A470101/47000350/" }
            ]
        },
        6: {
            title: "最終日・買い物",
            date: "03/15 (日)",
            events: [
                { time: "08:00", icon: "🍚", title: "朝食：風林火山", desc: "和定食", cost: "1,200", link: null },
                { time: "10:15", icon: "🛍️", title: "国際通り", desc: "ドン・キホーテ、牧志市場、お土産", cost: "10,000+", link: "https://naha-kokusaidori.okinawa/" },
                { time: "13:30", icon: "🚝", title: "那覇空港へ移動", desc: "昼食は空港で (ポークたまご/ラーメン)", cost: "1,000", link: "https://www.naha-airport.co.jp/" },
                { time: "16:55", icon: "🛫", title: "復路出発", desc: "タイ・エアアジア Flight 231", cost: "0", link: "https://www.airasia.com/jp/ja" },
                { time: "19:00", icon: "🏠", title: "台湾到着", desc: "桃園空港解散", cost: "0", link: null }
            ]
        }
    }
};
